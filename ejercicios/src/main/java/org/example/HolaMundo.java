...
//        }
//    }   //Definición de clase HolaMundo: esta línea usa la palabra clave class para declarar que se está definiendo una nueva clase. "HolaMundo" en este caso es un identificador que es el nombre de la clase.
//        //la definición de clase completa, incluidos todos sus miembros, estará entre la llave de apertura “{” y la llave de cierre “}”.
...
//        //El metodo main es el punto de entrada para la aplicación, y posteriormente invocará todos los otros métodos requeridos por el programa. System.out.println("Hola Mundo");
